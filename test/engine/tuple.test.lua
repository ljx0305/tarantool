...
maplen(t1map), t1map.field1, t1map.field2, t1map.field3
t2 = s:replace{4, 5, 6, 'extra1'}
t2map = t2:tomap()
maplen(t2map), t2map.field1, t2map.field2, t2map.field3, t2map[4]
t3 = s:replace{7, 8, 9, 'extra1', 'extra2'}
t3map = t3:tomap()
maplen(t3map), t3map.field1, t3map.field2, t3map.field3, t3map[4], t3map[5]
