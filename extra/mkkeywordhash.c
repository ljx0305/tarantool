...
static Keyword aKeywordTable[] = {
  ...
  { "ANALYZE",                "TK_ANALYZE",     ANALYZE,          false },
  ...
  { "REINDEX",                "TK_REINDEX",     REINDEX,          false },
  { "RELEASE",                "TK_RELEASE",     ALWAYS,           true  },
  { "RENAME",                 "TK_RENAME",      ALTER,            true  },
  { "REPLACE",                "TK_REPLACE",     CONFLICT,         false },
  ...
  { "INTERVAL",               "TK_STANDARD",    RESERVED,         true  },
  { "LEADING",                "TK_STANDARD",    RESERVED,         true  },
  { "LOCALTIME",              "TK_STANDARD",    RESERVED,         true  },
  { "LOCALTIMESTAMP",         "TK_STANDARD",    RESERVED,         true  },
  { "MOD",                    "TK_STANDARD",    RESERVED,         true  },
  { "MODIFIES",               "TK_STANDARD",    RESERVED,         true  },
  ...
  { "RETURNS",                "TK_STANDARD",    RESERVED,         true  },
  { "REVOKE",                 "TK_STANDARD",    RESERVED,         true  },
  { "ROWS",                   "TK_STANDARD",    RESERVED,         true  },
  { "SENSITIVE",              "TK_STANDARD",    RESERVED,         true  },
  { "SMALLINT",               "TK_STANDARD",    RESERVED,         true  },
  { "SOME",                   "TK_STANDARD",    RESERVED,         true  },
  { "SPECIFIC",               "TK_STANDARD",    RESERVED,         true  },
  { "SQLEXCEPTION",           "TK_STANDARD",    RESERVED,         true  },
  { "SQLSTATE",               "TK_STANDARD",    RESERVED,         true  },
  { "SQLWARNING",             "TK_STANDARD",    RESERVED,         true  },
  { "START",                  "TK_STANDARD",    RESERVED,         true  },
  { "TRAILING",               "TK_STANDARD",    RESERVED,         true  },
  { "TRUE",                   "TK_ID",          RESERVED,         false },
  { "USER",                   "TK_STANDARD",    RESERVED,         true  },
  { "WHENEVER",               "TK_STANDARD",    RESERVED,         true  },
  { "BIGINT",                 "TK_ID",          RESERVED,         true  },
  { "BINARY",                 "TK_ID",          RESERVED,         true  },
  { "BLOB",                   "TK_ID",          RESERVED,         true  },
  ...
  { "NUMERIC",                "TK_ID",          RESERVED,         true  },
  { "REAL",                   "TK_ID",          RESERVED,         true  },
  { "VARCHAR",                "TK_ID",          RESERVED,         true  },
  { "VARYING",                "TK_ID",          RESERVED,         true  },
};
